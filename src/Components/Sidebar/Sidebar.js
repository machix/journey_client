    ...
    render() {
        return (
            <div className={'sidebar'}>
                ...
                <AwesomeButton style={{marginTop: '30px'}} action={()=>this.props.remoteCapture(this.props.author.fcm_token)}>LIVE! Request An Update</AwesomeButton>
                ...
                <div className={'footer'}>
                    ...
                    <div>
                        <Icon className={'social-icon'} viewBox="0 0 40 40" size={this.props.windowWidth > 800 ? 25 : 18}>
                            <g>
                                <path
